...
int main(int argc, char* argv[])
{
	...
	const char * filename_skel;
	const char * filename_skin;
	...
	if (argc > 2)
	{
		...
		filename_skel = argv[1];
		filename_skin = argv[2];
	}
	else
	{
		cout << "No input file given. Defaulting to 'wasp.skel' and 'wasp.skin'" << endl;
		filename_skel = "wasp.skel";
		filename_skin = "wasp.skin";
	}
	Window::initialize_objects(filename_skel, filename_skin);
